        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('cetakrekapmediaexternal') }}" id="frmLaporanBerita" name="frmLaporanBerita"
                                  target="_blank"
                                  method="post">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <button type="submit" name="exportexcelrekapexternal" id="exportexcelrekapexternal"
