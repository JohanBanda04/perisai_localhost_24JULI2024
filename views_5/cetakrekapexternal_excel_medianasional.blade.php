...
<section class="sheet padding-10mm">
    ...
    <table style="width: 100%">
        <tr>
            <td colspan="7">
                <span id="title">
                     <center>REKAP BERITA MEDIA EXTERNAL (NASIONAL) {{ strtoupper($satker_name) }}</center>
                    <br>
        ...
        <div class="col-12">
            ...
            margin-right: auto;">
                        ...
                        @foreach($getberita as $index=>$dtberita)
                            ...
                            foreach ($links_media_nasional as $id=>$link_media_nasional){
                                 $kode_media = explode("|||",$link_media_nasional)[0];
                            ...
                            <tr class="overflowtes">
                                ...
                                <td style="width: auto; text-align: left" rowspan=""
                                    ...
                                    @php
                                        ...
                                        foreach ($links_media_nasional as $id=>$link_media_nasional){
                                            ...
                                            if(!empty(explode("|||",$link_media_nasional)[2])){
                                                $link_berita = explode("|||",$link_media_nasional)[2];
                                            ...
                                            foreach ($nama_media_nasional as $no_index=>$dtmedia){
                                    ...
                                    @elseif(count($dt_named_nasional) > 0 )
                                        @foreach($dt_named_nasional as $it=>$item)
                                ...
                                <td>
                                    ...
                                    @elseif(count($dt_linkberita_nasional) > 0 )
                                        @foreach($dt_linkberita_nasional as $itnews=>$itemnews)
            ...
            margin-right: auto;">
                        ...
                        <tr class="" style="">
                            ...
                            <th style="width: auto" rowspan="1" colspan="1">{{ $total_counting3_all }}</th>
