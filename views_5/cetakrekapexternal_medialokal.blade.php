    ...
    <table style="width: 100%">
        <tr>
            ...
            <td>
                <center>
                    <span id="title">
                   REKAP BERITA MEDIA EXTERNAL (LOKAL)<br>
        ...
        <div class="col-12">
            ...
            margin-right: auto;">
                        ...
                        <tr class="" style="">
                            ...
                            {{--ASLIII--}}
                            {{--untuk dapatkan total berita yg sama dgn jml link per media--}}
                            @php
