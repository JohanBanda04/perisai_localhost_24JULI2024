        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita','beritasatker/laporanberitamedia','beritasatker/rekapmediaexternal'])? 'show':'' }}"
                       href="#navbar-base" data-bs-toggle="dropdown"
                       data-bs-auto-close="false" role="button"
                       aria-expanded="{{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita','beritasatker/laporanberitamedia','beritasatker/rekapmediaexternal'])? 'true':'' }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                   <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-description"
                    ...
                    <div class="dropdown-menu {{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita','beritasatker/laporanberitamedia','beritasatker/rekapmediaexternal'])? 'show':'' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                @canany(['admin','humas_kanwil'])
                                <a class="dropdown-item {{ request()->is(['beritasatker/rekapmediaexternal'])? 'active':'' }}"
                                   href="{{ route('rekapmediaexternal') }}">
                                    Rekap Media External
                                </a>
                                @endcanany
